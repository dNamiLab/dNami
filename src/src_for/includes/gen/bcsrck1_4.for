...
subroutine boundaryScheme_faces_k1_4(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
#include "include_BClocVar_k1_4.f90"
...
#include "include_BCLoops_k1_4.f90"
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_faces_k1_4
