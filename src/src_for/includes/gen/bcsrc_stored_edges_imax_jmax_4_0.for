...
subroutine boundarySchemestored_edges_imax_jmax_4_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
#include "include_stored_edges_imax_jmax_4_0_BClocVar.f90"
...
#include "include_stored_edges_imax_jmax_4_0_BCLoops.f90"
...
!$OMP END DO
 ...
 end subroutine boundarySchemestored_edges_imax_jmax_4_0
