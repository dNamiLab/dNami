...
Fx = {'u'   : ' - visc *( 2.0_wp * {u}_1x + ( chi - 2.0_wp/3.0_wp ) * ( '+ ddivops +'  ) )',
      'v'   : ' - visc *( {u}_1y + {v}_1x )', 
      'et'  : ' - kappa*( {T}_1x ) '
              ' - u*(visc *( 2.0_wp * {u}_1x + ( chi - 2.0_wp/3.0_wp) * ( '+ ddivops +'  )))'
              ' - v*(visc *( {u}_1y + {v}_1x ))'}

Fy = {'u'   : ' - visc *( {u}_1y + {v}_1x )  ',
      'v'   : ' - visc *( 2.0_wp * {v}_1y + ( chi - 2.0_wp/3.0_wp ) * ( '+ ddivops +'  ) )', 
      'et'  : ' - kappa*( {T}_1y )'
              ' - u*(visc *( {u}_1y + {v}_1x ))'
              ' - v*(visc *( 2.0_wp * {v}_1y + ( chi - 2.0_wp/3.0_wp ) * ( '+ ddivops +'  )))'}
...
Src_skew = {'rho' : '0.5_wp*( [rho*u]_1x + [rho*v]_1y  '
                   '+   u*[rho]_1x + v*[rho]_1y  '
                   '+ rho*( '+divops+' ) )',
        'u'   : '0.5_wp*( [rho*u*u]_1x + [rho*u*v]_1y  '
                   '+   u*[rho*u]_1x + v*[rho*u]_1y '
                   '+rho*u*( '+divops+' ) ) + [p]_1x ',
        'v'   : '0.5_wp*( [rho*u*v]_1x + [rho*v*v]_1y  '
                   '+   u*[rho*v]_1x + v*[rho*v]_1y  '
                   '+rho*v*( '+divops+' ) ) + [p]_1y ',
        'et'  : '0.5_wp*( [rho*et*u]_1x + [rho*et*v]_1y '
                   '+   u*[rho*et]_1x + v*[rho*et]_1y '
                   '+rho*et*( '+divops+') ) + [p*u]_1x + [p*v]_1y '}

# Navier-Stokes Diffusive terms only (Laplacian form)

Src_Laplace = {'u'   : '- visc* ( [u]_2xx + [u]_2yy ) - visc*( chi + 0.3333333333333333_wp)*( [ '+ ddivops+' ]_1x )  ',
               'v'   : '- visc* ( [v]_2xx + [v]_2yy ) - visc*( chi + 0.3333333333333333_wp)*( [ '+ ddivops+' ]_1y )  ',
               'et'  : '- visc* ( ( [u]_2xx + [u]_2yy  )*u '
                       ' +        ( [v]_2xx + [v]_2yy  )*v )'
                       '- visc*(chi + 0.3333333333333333_wp)*('
                       '  [ '+ ddivops+' ]_1x * u '
                       '+ [ '+ ddivops+' ]_1y * v)'
                       '- visc* ('
                       ' ( 2.0_wp * [u]_1x * [u]_1x ) '
                       ...
                       '+( [v]_1x + [u]_1y ) * [u]_1y '
                       ')'
                       '-visc*(chi - 0.6666666666666666_wp) * ( ' + divops+' )*( ' + divops+' ) '} 

Src_Laplace['et'] = Src_Laplace['et'] + '- kappa* ( [T]_2xx + [T]_2yy )'                          
...
Src_phybc_conv = {'rho' : '[ '+PhyBcFx['rho']+' ]_1x' + ' + ' + '[ '+PhyBcFy['rho']+' ]_1y' + ' + ' + '[ '+PhyBcFz['rho']+' ]_1z ',
                  ...
                  'et' : ' [ '+PhyBcFx['et'] +' ]_1x' + ' + ' + '[ '+PhyBcFy['et'] +' ]_1y' + ' + ' + '[ '+PhyBcFz['et'] +' ]_1z '}
