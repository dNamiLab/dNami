...
Drt  = ' ( 1.0_wp / (2.0_wp * r) * ( {ur}_1y - ut  ) + 1.0_wp /2.0_wp * dutdr ) '
Drt2 = ' ( 1.0_wp / (2.0_wp * r) * ( [ur]_1y - ut  ) + 1.0_wp /2.0_wp * dutdr ) '
Dtt  = ' ( 1.0_wp / r * ( dutdt + ur ) - 1.0_wp/3.0_wp * divV ) '

visc_shear= { 
        'rho' : ' 0.0_wp  ', 
        'ur'  : ' - 2.0_wp * mu *( 1.0_wp / r * [r*'+Drr+']_1x + 1.0_wp / r * ['+Drt+']_1y - '+Dtt+'/r               ) ', 
        'ut'  : ' - 2.0_wp * mu *( 1.0_wp / r * [r*'+Drt+']_1x + 1.0_wp / r * ['+Dtt+']_1y + '+Drt2+'/r               ) ', 
