...
# Boundary conditions
    genBC(Save_eqns['divF']  ,5,4, rhsname , vnamesrc_divF, update=False,rhs=rhs,stored=True)

    if iVisc:
        genBC(Save_eqns['visc']  ,5,4, rhsname , vnamesrc_visc , update=True ,rhs=rhs,stored=False)
