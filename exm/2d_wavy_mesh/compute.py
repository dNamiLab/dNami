...
with_grid   = [160,80]   # number of points in each direction
...
if 'qstored' in dtree['eqns']['qvec']['views'].keys():
        dn.dnamiF.stored(intparam,fltparam,data,1) # compute static
...
# -- Running the case for different schemes
#scheme = '11_10'
#scheme = '9_8'
#scheme = '7_6'
#scheme = '5_4'
...
for n in range(ni,nitmax+ni):
        ...
        # -- output information with write out of vorticity field
