...
a[dom] = np.random.rand(nx+2*hlo) 
b[dom] = np.random.rand(nx+2*hlo)
...
if dMpi.ioproc:
    print('Diff in core:')
dn.dnami_io.globalMinMax(dtree,adiff[hlo:nx+hlo],'adiff')
dn.dnami_io.globalMinMax(dtree,bdiff[hlo:nx+hlo],'bdiff')
if dMpi.ioproc:
